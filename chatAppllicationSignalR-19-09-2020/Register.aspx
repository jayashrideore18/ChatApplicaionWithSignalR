<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="chatAppllicationSignalR_19_09_2020.Register" %>
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>
      ...
      <div class="form-group has-feedback">
          <%--<asp:TextBox ID="txtName" Text="Full Name" runat="server" />--%>
